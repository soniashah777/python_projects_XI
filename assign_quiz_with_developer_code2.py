...
def remove_question_by_index():
    # Enter code to remove questions by index
def list_by_range():
    # Enter code to list questions by range
def add_questions():
    enter="y"
    while enter=="y":
...
if (choice=="d"):
    if (input ("Enter username") == uname and input ("enter password")==password):
        while True:
            ...
            print ("Enter lr for listing questions by range")
            print ("Enter i for removing questions by index")
